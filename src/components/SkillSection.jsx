...
const SkillSection = () => {
  return (
    <section className="bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-20 px-4">
      <div className="mb-10 text-center">
        {/* Section Title */}
        <h2 className="text-3xl md:text-4xl font-bold text-purple-500 inline-flex items-center gap-2">
            <FaTools className="text-purple-400" />Skills & Expertise</h2>
          ...
          {skills.map((skill, i) => (
            <div key={i}>
              ...
              <div className="w-full h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full transition-all duration-700 ease-in-out"
